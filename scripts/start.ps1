...
$containerCleanupModule = Join-Path $ScriptDir "container_cleanup\ContainerCleanup.psm1"
Import-Module $containerCleanupModule -Force
...
$containerList = @(Get-MindscapeConflictingContainers)
