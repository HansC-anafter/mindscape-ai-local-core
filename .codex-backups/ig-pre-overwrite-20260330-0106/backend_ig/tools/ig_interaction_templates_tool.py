...
from capabilities.ig.services.interaction_templates import InteractionTemplates
...
class IGInteractionTemplatesTool(MindscapeTool):
    ...
    async def execute(self, **kwargs) -> ToolExecutionResult:
        ...
        try:
            ...
            if workspace_path:
                # In enterprise mode, custom_path is only allowed if explicitly enabled
            ...
            templates = InteractionTemplates(storage)
...
# Wrapper function for manifest validation (lowercase function name)
def ig_interaction_templates_tool():
    """Wrapper function for IGInteractionTemplatesTool (for manifest validation compliance)"""
    return IGInteractionTemplatesTool()
