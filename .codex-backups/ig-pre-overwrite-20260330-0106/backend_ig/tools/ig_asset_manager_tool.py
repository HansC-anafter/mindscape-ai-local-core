    ...
    async def execute(self, **kwargs) -> ToolExecutionResult:
        ...
        try:
            ...
            if workspace_path:
                ...
                # WARNING: Only allowed in migration/single-user mode
...
def ig_asset_manager_tool():
    """Wrapper function for IGAssetManagerTool (for manifest validation compliance)"""
    return IGAssetManagerTool()
