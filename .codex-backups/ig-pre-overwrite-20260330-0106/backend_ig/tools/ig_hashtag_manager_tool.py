...
from capabilities.ig.services.hashtag_manager import HashtagManager
    ...
    def __init__(self):
        input_schema = ToolInputSchema(
            ...
            properties={
                ...
                "intent": {
                    "type": "string",
                    "enum": ["education", "traffic", "conversion", "brand"],
...
def ig_hashtag_manager_tool():
    """Wrapper function for IGHashtagManagerTool (for manifest validation compliance)"""
    return IGHashtagManagerTool()
