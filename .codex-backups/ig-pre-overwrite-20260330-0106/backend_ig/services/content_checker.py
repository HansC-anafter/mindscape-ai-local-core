...
class ContentChecker:
    ...
    def _check_medical_claims(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "warnings": [
                f"Medical claim keywords detected: {', '.join(found_keywords)}. Please verify compliance requirements."
    ...
    def _check_investment_claims(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "keywords_found": found_keywords,
            "warnings": [
                f"Investment claim keywords detected: {', '.join(found_keywords)}. Please verify compliance requirements."
            ] if found_keywords else []
        }
    ...
    def _check_copyright(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "keywords_found": found_keywords,
            "warnings": [
                f"Copyright-risk keywords detected: {', '.join(found_keywords)}. Please verify you have the required rights/attribution."
            ] if found_keywords else []
        }
    ...
    def _check_personal_data(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "warnings": [
                f"Potential personal data detected ({len(found_patterns)} occurrences). Please verify consent and compliance."
    ...
    def _check_brand_tone(self, content: str) -> Dict[str, Any]:
        ...
        if negative_found:
            warnings.append(
                f"Potential brand-tone issues detected: {', '.join(negative_found)}. Consider using more professional phrasing."
            )
