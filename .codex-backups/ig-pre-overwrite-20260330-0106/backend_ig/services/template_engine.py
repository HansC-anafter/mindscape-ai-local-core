...
class IGTemplateEngine:
    ...
    def _get_cta_templates(self, purpose: str) -> List[str]:
        ...
        ctas = {
            "save": [
                "Save this post so you can come back later.",
                "Bookmark this for later.",
                "Keep this handy for your next session."
            ],
            "comment": [
                "Share your thoughts in the comments.",
                "What do you think? Tell me below.",
                "Reply with your experience in the comments."
            ],
            "dm": [
                "Send me a DM if you want more details.",
                "DM me and I will share more context.",
                "Message me if you want a personalized suggestion."
            ],
            "share": [
                "Share this with a friend who might need it.",
                "Forward this to someone who would benefit.",
                "Share this to help more people see it."
            ]
        }
    ...
    def _apply_template(
        ...
        return {
            ...
            "has_emoji": bool(re.search(r"[\U0001F300-\U0001FAFF]", post_text)),
            "has_cta": bool(cta),
