...
### Added
- Modular installed-extension system with comprehensive validation
- `.mindpack` packaging format and install-from-file API
- System tool detection for installed extension setup
- Database migration support within installed extensions
...
### Changed
- Migrated extension installation to modular installer architecture
...
- Engineering safeguards to prevent committing installed-extension files
...
- Extension registry with suite discovery API
