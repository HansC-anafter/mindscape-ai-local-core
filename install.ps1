...
Write-Host "  .\scripts\start_cli_bridge_supervisor.ps1 -All" -ForegroundColor White
Write-Host ""
...
Write-Host "  3. Use the manual override above only if the platform service wrapper is unavailable"
Write-Host ""
