  ...
  return (
    <div className="bg-white border rounded p-2 shadow-sm">
      ...
      <div className="space-y-2">
        {/* 本工作空间目前在做什么 */}
        <div>
          <div className="text-[10px] text-gray-500 mb-0.5">{t('workspaceCurrentlyDoing' as any) || '本工作空間目前在處理'}</div>
          <div className="text-xs text-gray-900 font-medium">
            {context.workspace_focus ? (
              ...
              <span className="text-gray-400">{context.workspace_focus_key ? t(context.workspace_focus_key as any) : t('noClearWorkspaceFocus' as any)}</span>
            )}
          </div>
        </div>
