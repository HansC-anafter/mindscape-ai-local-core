      ...
      >
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-3">
            {conflict.message || 'The target file already exists. Do you want to overwrite it?'}
          </p>
          ...
          {conflict.suggestedVersion && (
            <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-3">
              <p className="text-sm text-blue-800">
                <strong>Recommendation:</strong> Use new version <code className="font-mono font-semibold">v{conflict.suggestedVersion}</code> to avoid overwriting the existing file.
              </p>
            </div>
          )}
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
            <p className="text-sm text-yellow-800">
              <strong>Warning:</strong> Overwriting the existing file will permanently remove the previous version. This action cannot be undone.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-3 justify-end">
          ...
          {conflict.suggestedVersion && onUseNewVersion ? (
            ...
            >
              Use New Version (v{conflict.suggestedVersion})
            </button>
          ) : null}
          <button
            onClick={onConfirm}
