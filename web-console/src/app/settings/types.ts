...
export type SettingsTab = 'basic' | 'credentials' | 'mindscape' | 'ai-team-governance' | 'social_media' | 'tools' | 'localization' | 'service_status' | 'workspace_products' | 'packs_status' | 'governance' | 'runtime' | 'remote_workbench_access';
