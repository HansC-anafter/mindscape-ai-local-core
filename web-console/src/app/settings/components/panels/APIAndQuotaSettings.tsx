...
export function APIAndQuotaSettings({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">{t('apiAndQuota') || 'API 與配額'}</h3>
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
          {t('apiAndQuotaDescription') || '配置 LLM API 金鑰和管理使用配額'}
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {t('openaiApiKey')} <span className="text-gray-500 dark:text-gray-400">({t('apiKeyOptional')})</span>
            </label>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {t('anthropicApiKey')} <span className="text-gray-500 dark:text-gray-400">({t('apiKeyOptional')})</span>
            </label>
        ...
        <div className="border-t dark:border-gray-700 pt-4">
          <h4 className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">{t('quotaUsage') || '配額使用情況'}</h4>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            {t('quotaUsageDescription') || '配額管理功能即將推出'}
          </p>
        </div>
      </div>
    </div>
