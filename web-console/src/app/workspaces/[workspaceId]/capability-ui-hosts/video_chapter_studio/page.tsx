import VideoChapterStudioCapabilityUiHost from './VideoChapterStudioCapabilityUiHost';
...
export default async function CapabilityUiHostPage({
  ...
  return renderCapabilityUiHostPage({
    ...
    capabilityCode: 'video_chapter_studio',
    HostComponent: VideoChapterStudioCapabilityUiHost,
  });
}
