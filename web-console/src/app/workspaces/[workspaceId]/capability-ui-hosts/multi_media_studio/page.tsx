import MultiMediaStudioCapabilityUiHost from './MultiMediaStudioCapabilityUiHost';
...
export default async function CapabilityUiHostPage({
  ...
  return renderCapabilityUiHostPage({
    ...
    capabilityCode: 'multi_media_studio',
    HostComponent: MultiMediaStudioCapabilityUiHost,
  });
}
