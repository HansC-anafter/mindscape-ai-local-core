import WorldAssetForgeCapabilityUiHost from './WorldAssetForgeCapabilityUiHost';
...
export default async function CapabilityUiHostPage({
  ...
  return renderCapabilityUiHostPage({
    ...
    capabilityCode: 'world_asset_forge',
    HostComponent: WorldAssetForgeCapabilityUiHost,
  });
}
