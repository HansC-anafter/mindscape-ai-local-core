import PracticeCompanionCapabilityUiHost from './PracticeCompanionCapabilityUiHost';
...
export default async function CapabilityUiHostPage({
  ...
  return renderCapabilityUiHostPage({
    ...
    capabilityCode: 'practice_companion',
    HostComponent: PracticeCompanionCapabilityUiHost,
  });
}
