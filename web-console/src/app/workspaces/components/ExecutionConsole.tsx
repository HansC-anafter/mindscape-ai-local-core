            ...
            {execution?.origin_intent_label && (
              <p className="text-sm text-gray-600 mt-1">
                ...
                {execution.origin_intent_id && execution.trigger_source === 'auto' && (
                  <span className="text-gray-500 ml-2">{t('executionAISuggested')}</span>
                )}
              </p>
            )}
          </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {step.requires_confirmation && (
                          <div className="text-xs text-yellow-600 mt-1">{t('executionRequiresConfirmation')}</div>
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {currentStep ? (
              ...
              <div className="text-center text-gray-500 py-8">
                {t('executionSelectStepForDetails')}
              </div>
            )}
          </div>
        </div>
