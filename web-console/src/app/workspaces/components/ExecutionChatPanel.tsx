        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">{t('runNumber', { number: runNumber })}</p>
            </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-600 mt-0.5">
              {playbookMetadata?.title || playbookMetadata?.playbook_code || t('unknownPlaybook')} · {t('runNumber', { number: runNumber })}
            </p>
          </div>
          {collapsible && (
            <button
