                                ...
                                <div className="text-xs text-gray-600 dark:text-gray-400 flex items-center justify-between">
                                  ...
                                  {selectedWorkspaceId && (
                                    <button
                                      ...
                                      title={playbook.pinned_workspaces?.some(ws => ws.id === selectedWorkspaceId) ? t('unpin' as any) : t('pin' as any)}
                                    >
                                      {playbook.pinned_workspaces?.some(ws => ws.id === selectedWorkspaceId) ? t('unpin' as any) : t('pin' as any)}
                                    </button>
                                  )}
                                </div>
                              </div>
