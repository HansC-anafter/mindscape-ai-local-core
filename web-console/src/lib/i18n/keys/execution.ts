...
export const executionKeys = {
  ...
  tabScheduling: true,
  tabSchedulingSubtitle: true,
  tabOutcomes: true,
  tabOutcomesSubtitle: true,
  tabBackgroundTasks: true,
  tabBackgroundTasksSubtitle: true,
  tabPack: true,
  tabPackSubtitle: true,
  packPanel: true,
  installedCapabilities: true,
  packUIEntryPoints: true,
  ...
  enterResponseToContinue: true,
  playbookWaitingForResponse: true,
  sendMessageToContinue: true,
