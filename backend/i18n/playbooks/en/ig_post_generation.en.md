...
Generate multiple Instagram posts from source content (such as OCR text, articles, notes, etc.), optimized for IG platform features including character limits, hashtag usage, tone adjustment, and more.
...
2. **Generate Posts**: Create multiple IG-formatted posts based on topics
...
- `ig_posts`: Generated IG posts list, each containing:
...
- IG post recommended length: within 2,200 characters
