...
Phase 0: SSOT idempotency table. Each dispatch attempt registers its
unique idempotency_key BEFORE execution. The UNIQUE constraint prevents
duplicate dispatches at the database level.
