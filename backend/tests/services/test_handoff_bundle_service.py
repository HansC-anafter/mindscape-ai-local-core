...
class TestCompileHappyPath:
    ...
    async def test_compile_happy_path_produces_task_ir(self):
        ...
        fake_execution_launcher = MagicMock(name="execution_launcher")
        ...
        assert (
            ...
            is fake_execution_launcher
        )
        mod_pipeline_meeting.build_execution_launcher.assert_called_once()
    ...
    async def test_compile_replaces_converged_generating_orphan_session(self):
        ...
        # Freshness alone should NOT block replacement in this test.
        mod_session_store.is_active_session_fresh = MagicMock(return_value=True)
