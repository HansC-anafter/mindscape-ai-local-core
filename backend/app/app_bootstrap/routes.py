...
def register_core_routes(app: FastAPI) -> None:
    ...
    from backend.app.routes.core.knowledge_benchmarks import router as knowledge_benchmarks_router
    from backend.app.routes.core.knowledge_access import (
        router as knowledge_access_router,
    )
    ...
    app.include_router(knowledge_benchmarks_router)
    ...
    register_workspace_access_control_routes(app)
