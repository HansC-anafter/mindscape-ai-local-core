...
from backend.app.services.handoff_bundle_compile import (
    compile_handoff_in as _compile_handoff_in,
)
from backend.app.services.handoff_bundle_recovery import (
    build_compile_job_recovery_request as _build_compile_job_recovery_request,
    enum_value as _enum_value,
    looks_like_orphan_compile_session as _looks_like_orphan_compile_session,
    reuse_terminal_compile_result as _reuse_terminal_compile_result,
    should_supersede_active_session as _should_supersede_active_session,
)
...
class HandoffBundleService:
    ...
    async def compile_handoff_in(
        ...
        return await _compile_handoff_in(
            handoff_in=handoff_in,
            workspace=workspace,
            runtime_profile=runtime_profile,
            profile_id=profile_id,
