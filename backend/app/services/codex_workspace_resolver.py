...
Resolves which Codex pool runtime should serve a workspace execution when
the workspace explicitly opts into Codex and may optionally pin a runtime.
"""
...
class CodexWorkspaceResolver:
    """Resolve the workspace-scoped Codex pool runtime for an execution."""
