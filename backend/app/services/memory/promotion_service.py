...
from backend.app.services.memory import (
    promotion_related_transitions as related_transitions,
)
...
class MemoryPromotionService:
    ...
    def _verify_related_knowledge(
        ...
        related_transitions.verify_related_knowledge(
            self.personal_knowledge_store,
            knowledge_ids,
    ...
    def _stale_related_knowledge(self, knowledge_ids: List[str]) -> None:
        related_transitions.stale_related_knowledge(
            self.personal_knowledge_store,
            knowledge_ids,
        )
    ...
    def _deprecate_related_knowledge(
        ...
        related_transitions.deprecate_related_knowledge(
            self.personal_knowledge_store,
            knowledge_ids,
            successor_memory_id=successor_memory_id,
        )
    ...
    def _activate_related_goals(self, goal_ids: List[str], *, reason: str) -> None:
        related_transitions.activate_related_goals(
            self.goal_ledger_store,
            goal_ids,
            reason=reason,
        )

    def _stale_related_goals(self, goal_ids: List[str], *, reason: str) -> None:
        related_transitions.stale_related_goals(
            self.goal_ledger_store,
            goal_ids,
            reason=reason,
        )
    ...
    def _deprecate_related_goals(self, goal_ids: List[str], *, reason: str) -> None:
        related_transitions.deprecate_related_goals(
            self.goal_ledger_store,
            goal_ids,
            reason=reason,
        )
