...
from .conversation.plan_builder import PlanBuilder
from .conversation.task_manager import TaskManager
from .conversation.cta_handler import CTAHandler
from .conversation.file_processor import FileProcessor
from .conversation.suggestion_action_handler import SuggestionActionHandler
from .conversation.execution_coordinator import ExecutionCoordinator
from .conversation.qa_response_generator import QAResponseGenerator
from .conversation.message_generator import MessageGenerator
...
class ConversationOrchestrator:
    ...
    def __init__(
        ...
        if intent_registry is None:
            from ..adapters.local.local_intent_registry_adapter import LocalIntentRegistryAdapter
        ...
        try:
            ...
            if intent_result and intent_result.is_multi_step:
                ...
                try:
                    ...
                    from ..services.handoff_plan_extractor import HandoffPlanExtractor
