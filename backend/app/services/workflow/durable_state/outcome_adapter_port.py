    ...
    def evaluate(
        ...
        *,
        ...
        for observation in observations:
            ...
            encode(observation)
            public_key = self._observation_verification_keys.get(
                observation["key_id"]
            )
            if public_key is None:
                raise ValueError(
                    "outcome observation signing key is unavailable"
                )
            verify(
                public_key,
                encode(
    ...
    def _require_identity(
        ...
        *,
        ...
        expected = {
            ...
            "consumer_compatibility_class": enrollment[
                "consumer_compatibility_class"
            ],
            "configuration_fingerprint": enrollment[
                "configuration_fingerprint"
            ],
            "environment_fingerprint": enrollment[
