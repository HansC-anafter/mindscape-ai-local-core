...
from .capability_installer_result import CapabilityInstallerResultMixin, LegacyResult
from .capability_installer_runtime_assets import CapabilityInstallerRuntimeAssetsMixin
...
class CapabilityInstaller(
    CapabilityInstallerResultMixin,
    CapabilityInstallerRuntimeAssetsMixin,
):
