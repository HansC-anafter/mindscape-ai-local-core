...
from .default_local_browser import (
    ...
    LEGACY_DEFAULT_LOCAL_QUEUE_PARTITION,
)

DEFAULT_LOCAL_QUEUE_PARTITION = LEGACY_DEFAULT_LOCAL_QUEUE_PARTITION
BROWSER_LOCAL_QUEUE_PARTITION = "browser_local"
VISION_LOCAL_QUEUE_PARTITION = "vision_local"
KNOWLEDGE_INDEXING_QUEUE_PARTITION = "knowledge_indexing"
...
_QUEUE_PARTITION_ALIASES = {
    DEFAULT_LOCAL_QUEUE_PARTITION: (
        LEGACY_DEFAULT_QUEUE_PARTITION,
    ),
    DEFAULT_LOCAL_BROWSER_QUEUE_PARTITION: (),
...
_LEGACY_TO_CANONICAL = {
    LEGACY_DEFAULT_LOCAL_QUEUE_PARTITION: DEFAULT_LOCAL_QUEUE_PARTITION,
