...
from backend.app.services.ig_obsidian.complete_workflow import CompleteWorkflow
...
class IGCompleteWorkflowTool(MindscapeTool):
    ...
    async def execute(self, **kwargs) -> ToolExecutionResult:
        ...
        try:
            ...
            workflow = CompleteWorkflow(vault_path)
            ...
            if action == "execute_workflow":
                ...
                target_folder = kwargs.get("target_folder", "20-Posts")
