...
from backend.app.services.ig_obsidian.metrics_backfill import MetricsBackfill
...
class IGMetricsBackfillTool(MindscapeTool):
    ...
    async def execute(self, **kwargs) -> ToolExecutionResult:
        ...
        Args:
            ...
            post_path: Path to post file (for most actions)
        ...
        try:
            ...
            backfill = MetricsBackfill(vault_path)
