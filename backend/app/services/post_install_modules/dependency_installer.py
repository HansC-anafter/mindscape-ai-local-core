...
Handles installation of Python and UI dependencies.
"""
...
class DependencyInstaller:
    """Handles dependency installation (Python and UI)"""
    ...
    def install_ui_dependencies(
        ...
        """
        Install UI dependencies from manifest.yaml ui_dependencies field
