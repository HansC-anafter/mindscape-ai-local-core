...
class InteractionTemplates:
    ...
    def __init__(self, workspace_storage: WorkspaceStorage):
        ...
        templates_dir = self.storage.get_capability_root() / "interaction_templates"
        templates_dir.mkdir(parents=True, exist_ok=True)
        self.templates_index_path = templates_dir / "templates_index.json"
    ...
    def _save_templates_index(self, templates_index: Dict[str, Any]) -> None:
        ...
        try:
            self.templates_index_path.parent.mkdir(parents=True, exist_ok=True)
