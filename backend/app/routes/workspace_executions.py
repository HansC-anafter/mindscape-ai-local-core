...
async def confirm_step(
    ...
    try:
        ...
        # TODO: Trigger next step execution (this would be handled by PlaybookRunner)
...
async def cancel_execution(
    ...
    try:
        ...
        # TODO: Stop all running tool calls and steps
...
async def post_execution_chat(
    ...
    identity_port: IdentityPort = Depends(get_identity_port_or_default),  # ⭐ Aligned with Port architecture
):
    """
    ...
    try:
        ...
        # ⭐ Get ExecutionContext (aligned with Port architecture)
        ...
        user_event = MindEvent(
            ...
            workspace_id=ctx.workspace_id,  # ⭐ Use ctx.workspace_id
            event_type=EventType.EXECUTION_CHAT,
            payload={
                "execution_id": execution_id,
                "step_id": request.step_id,
                "role": "user",
                "speaker": ctx.actor_id,  # ⭐ Use ctx.actor_id
        ...
        # ⭐ Generate assistant reply asynchronously (aligned with Port architecture)
