"""
Tool Connection API Routes (DEPRECATED - DO NOT USE)

This route has been fully deprecated and replaced by /api/v1/tools/connections.
This file is kept for reference only and should not be imported or used.

Status: REMOVED FROM ACTIVE CODEBASE
- All functionality migrated to /api/v1/tools/connections
- All routes removed from main.py
...
from ...services.deprecated.tool_connection_store_deprecated import ToolConnectionStore
