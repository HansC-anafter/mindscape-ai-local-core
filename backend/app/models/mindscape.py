...
class EventType(str, Enum):
    ...
    OBSIDIAN_NOTE_UPDATED = (
        "obsidian_note_updated"  # Obsidian note creation/update events
    )
    ...
    PIPELINE_STAGE = "pipeline_stage"  # Async pipeline processing stage (Thinking...)
    ...
    BRANCH_PROPOSED = (
        "branch_proposed"  # Tree of Thoughts: alternative branches proposed
    )
