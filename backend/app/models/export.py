...
class ConsoleKitTemplate(BaseModel):
    ...
    capability_packs: List[Dict[str, Any]] = Field(
        ...
        description="Capability packs derived from intent cards"
    )
    ...
    agent_backend_config: Dict[str, Any] = Field(
        default_factory=dict,
        description="Agent backend configuration template"
    )

    # Statistics and metadata
    metadata: Dict[str, Any] = Field(
        default_factory=dict,
        description="Additional metadata about this template"
    )
...
class ConsoleKitExportRequest(BaseModel):
    ...
    # Options
    include_intent_cards: bool = Field(default=True, description="Include intent cards as capability packs")
    include_usage_statistics: bool = Field(default=False, description="Include usage statistics in metadata")
