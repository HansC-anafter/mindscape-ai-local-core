...
def upgrade():
    op.create_table(
        ...
        sa.Column('binding_config', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    # Create indexes
    op.create_index('idx_workspace_runtime_channel', 'channel_bindings', ['workspace_id', 'runtime_id', 'channel_id'], unique=False)
    op.create_index(op.f('ix_channel_bindings_workspace_id'), 'channel_bindings', ['workspace_id'], unique=False)
    op.create_index(op.f('ix_channel_bindings_runtime_id'), 'channel_bindings', ['runtime_id'], unique=False)
    op.create_index(op.f('ix_channel_bindings_channel_id'), 'channel_bindings', ['channel_id'], unique=False)
    op.create_index(op.f('ix_channel_bindings_agency'), 'channel_bindings', ['agency'], unique=False)
    op.create_index(op.f('ix_channel_bindings_tenant'), 'channel_bindings', ['tenant'], unique=False)
    op.create_index(op.f('ix_channel_bindings_chainagent'), 'channel_bindings', ['chainagent'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_channel_bindings_workspace_id'), table_name='channel_bindings')
