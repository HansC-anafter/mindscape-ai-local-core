...
def upgrade() -> None:
    ...
    op.create_index('idx_mindscape_personal_source', 'mindscape_personal', ['source_type'])
    op.create_index('idx_mindscape_personal_updated_at', 'mindscape_personal', [sa.text('updated_at DESC')])
    op.create_index('idx_mindscape_personal_metadata', 'mindscape_personal', ['metadata'], postgresql_using='gin')
    ...
    op.create_index('idx_suggestions_generated_at', 'mindscape_suggestions', [sa.text('generated_at DESC')])
    ...
    op.create_index('idx_playbook_knowledge_code', 'playbook_knowledge', ['playbook_code'])
    op.create_index('idx_playbook_knowledge_section', 'playbook_knowledge', ['section_type'])
    op.create_index('idx_playbook_knowledge_metadata', 'playbook_knowledge', ['metadata'], postgresql_using='gin')
    ...
    op.create_index('idx_external_docs_source_id', 'external_docs', ['source_app', 'source_id'])
    op.create_index('idx_external_docs_metadata', 'external_docs', ['metadata'], postgresql_using='gin')
    op.create_unique_index('idx_external_docs_unique_source', 'external_docs', ['user_id', 'source_app', 'source_id'])
    ...
    op.create_index('idx_voice_profiles_instructor', 'voice_profiles', ['instructor_id'])
    op.create_index('idx_voice_profiles_status', 'voice_profiles', ['status'])
    op.create_index('idx_voice_profiles_sample_paths', 'voice_profiles', ['sample_paths'], postgresql_using='gin')
    ...
    op.create_index('idx_voice_training_jobs_profile', 'voice_training_jobs', ['voice_profile_id'])
    op.create_index('idx_voice_training_jobs_instructor', 'voice_training_jobs', ['instructor_id'])
    op.create_index('idx_voice_training_jobs_status', 'voice_training_jobs', ['status'])
    op.create_index('idx_voice_training_jobs_config', 'voice_training_jobs', ['training_config'], postgresql_using='gin')
    ...
    op.create_index('idx_video_segments_instructor', 'video_segments', ['instructor_id'])
    op.create_index('idx_video_segments_course', 'video_segments', ['course_id'])
    op.create_index('idx_video_segments_quality', 'video_segments', [sa.text('quality_score DESC')])
    op.create_index('idx_video_segments_tags', 'video_segments', ['tags'], postgresql_using='gin')
